...
const Form = ({ handleClickHide }) => {
  ...
  return (
    <div className="absolute top-0 left-0 z-50 flex items-center justify-center w-full h-screen bg-slate-700">
      <form
        className="w-5/6 p-4 pt-6 mt-4 rounded shadow-xl bg-slate-900"
      ...
      >
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          ...
          <div className="relative z-0 w-full mb-6 group">
            <input
              ...
              name="birthdate"
              id="birthdate"
              className="block py-2.5 px-0 w-full text-sm text-white dark:text-black bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
        ...
        <div className="flex gap-2">
          ...
          <button
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-slate-600 dark:hover:bg-slate-700 dark:focus:ring-slate-800 mt-6"
